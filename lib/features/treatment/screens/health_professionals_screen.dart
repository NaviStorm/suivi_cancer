...
class _HealthProfessionalsScreenState extends State<HealthProfessionalsScreen> {
  ...
  final GlobalKey<EstablishmentListWidgetState> listKey = GlobalKey<EstablishmentListWidgetState>();
  final GlobalKey<DoctorListWidgetState> listKeyPS = GlobalKey<DoctorListWidgetState>();
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 8),
              DoctorListWidget(key: listKeyPS),
              SizedBox(height: 24),
              Text(
                'Établissements',
                style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
