...
class EditPSScreen extends StatefulWidget {
  final Map<String, dynamic>? ps;

  EditPSScreen({this.ps});

  @override
  _EditPSScreenState createState() => _EditPSScreenState();
}

class _EditPSScreenState extends State<EditPSScreen> {
  ...
  void initState() {
    super.initState();
    if (widget.ps != null) {
      print("PS reçu: ${widget.ps}");
      if (widget.ps!['contacts'] != null) {
        print("Contacts: ${widget.ps!['contacts']}");
      }
      if (widget.ps!['addresses'] != null) {
        print("Adresses: ${widget.ps!['addresses']}");
      }
      if (widget.ps!['establishments'] != null) {
        print("Établissements: ${widget.ps!['establishments']}");
      }
    }
    _loadData();
  }
  ...
  Future<void> _loadData() async {
    ...
    if (widget.ps != null) {
      ...
      final psData = psList.firstWhere((ps) => ps['id'] == psId, orElse: () => widget.ps!);
      ...
      if (psData['establishments'] != null) {
        _selectedEstablishments = List<Map<String, dynamic>>.from(psData['establishments']);
      }
    }
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      trailing: _selectedCategoryId == category['id']
                          ? Icon(CupertinoIcons.check_mark, color: Colors.blue)
                          : null,
                      onTap: () {
                        setState(() {
  ...
  void _selectEstablishments() async {
    final result = await showDialog<List<Map<String, dynamic>>>(
      context: context,
      builder: (context) => EstablishmentSelectionDialog(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                              color: _selectedCategoryId != null ? Colors.black : Colors.grey[600],
                              fontSize: 16,
                            ),
                          ),
                ...
                children: [
                  ...
                  if (_selectedEstablishments.isEmpty)
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final establishment = _selectedEstablishments[index];
                        return ListTile(
